...
if [ -z "$withdebs" ] || [ ! -d "$withdebs" ]; then
	release_branch_ver=$(curl -s https://raw.githubusercontent.com/KetlinUA/hestiacp/release/src/deb/hestia/control | grep "Version:" | awk '{print $2}')
	if [ "$HESTIA_INSTALL_VER" != "$release_branch_ver" ]; then
		...
		echo ""
		echo -e "\e[33mhttps://raw.githubusercontent.com/KetlinUA/hestiacp/release/install/hst-install.sh\e[0m"
		echo ""
...
case $architecture in
	...
	*)
		...
		echo ""
		echo -e "\e[33mhttps://github.com/KetlinUA/hestiacp/blob/main/README.md\e[0m"
		echo ""
		check_result 1 "Installation aborted"
		;;
esac
